# Safest way to deal with local times -> immediately convert them to UTC
# Only converting back to local time -> when u display to users of program

# naive time -> time with no timezone associated with them
